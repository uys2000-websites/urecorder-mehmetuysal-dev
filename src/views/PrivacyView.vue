<template>
  <div class="h-page overflow-auto">
    <div class="prose m-auto p-4 bg-base-100 my-4 rounded-box">
      ...
      <ul>
        ...
        <li>
          <p><strong>Application</strong> refers to URecorder, the software program provided by the Company.</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to URecorder.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to URecorder, accessible from <a href="https://urecorder.mehmetuysal.dev"
              rel="external nofollow noopener" target="_blank">https://urecorder.mehmetuysal.dev</a></p>
        </li>
        <li>
